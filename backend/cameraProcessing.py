...
class CameraProcessor:
    def __init__(self):
        ...
        self.rtspUrl = 0  # Replace this with the actual RTSP URL or use 0 for a webcam
    ...
    def processFrame(self, frame):
        try:
            results = self.model.track(frame, persist=True, show=False, imgsz=1280, verbose=False, conf=0.5)
